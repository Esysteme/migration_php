<?php
$_TABLE['create'] ="CREATE TABLE `species_main` (
...
$_TABLE['field'] = array("id","id_species_genus","id_species_iucn","id_species_taxon_author","date_author","is_valid","scientific_name","date_created","date_updated");
?>