<?php
$_TABLE['create'] ="CREATE TABLE `species_picture_in_wait` (
...
) ENGINE=MyISAM AUTO_INCREMENT=224966 DEFAULT CHARSET=utf8";
$_TABLE['field'] = array("id","id_species_main","id_species_sub","id_changes","id_from","id_species_picture_info","id_user_main","m_d5","url_md5","url_found","url_context","id_species_action_detail","author","copyright","is_linked","height","width","crop","date_created","name","date_validated","id_species_pictures_type");
?>